...
- 还没完成对象校准，就直接抓主要矛盾、谈资源压注、做公开定性。
- 还没完成结构诊断和阶段判断，就直接推联盟、沟通、rollout 或组织换挡。
- 识别信号：事实少、口号多；对象混；“先干再说”正在替代判断。

### 2. 把高压方法下沉到轻问题

- 把结构诊断、联盟边界、阶段转段、复杂 rollout 拿去处理轻量摩擦、单点技术问题或普通一对一误会。
- 把 `总动员`、`持久战`、`最后一战`、`战略决战` 这类重方法直接扣到普通项目卡点、恋爱摩擦、轻量协作失配上。
- 识别信号：问题本来可以直接澄清或处理，却被拉成“敌我”“阶段”“总路线”“决战期”。
...
### 5. 把执行、纠偏和协同做成官僚化或清洗化

- 用开会、报表、督办替代闭环。
- 用批评、整顿、口径统一替代真实纠偏。
- 把 `整风/纠偏` 误用成清洗异己、羞辱对象或借机报复。
- 把 `集中统一`、`组织换挡` 误用成单纯加控制、加审批、加威压。

### 6. 把真假和平、程序检查和证据链做成阴谋论

- 还没查清授权、程序、条款和事实链，就先宣布对方所有动作都别有用心。
- 只抓一个异常信号，就把谈判、合作、程序、合法性全都解释成骗局。
- 把 `真假和平`、`程序检查`、`合法性争夺` 用成拼贴阴谋、制造恐慌，而不是做条款、授权、顺序和证据校验。

### 7. 只讲方法，不接承接链

- 谈了对象、结构、阶段、表达，但没有落到资源、规则、班子、反馈和下一轮入口。
- 识别信号：方法上说得通，现场却接不住。
...
1. 先判断这是“方法被用坏”，还是“表达被乱翻”。
2. 如果是前者，先看这张入口页。
3. 如果这里已经点到具体表达，再去对应独立风险卡。
4. 如果风险来自某张方法卡的调用顺序错误，先退回那张卡的前置方法，而不是继续往后推。
